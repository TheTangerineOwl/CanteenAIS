...
namespace CanteenAIS_ViewModel.EntityViewModels.Ingredient
{
    ...
    {
        public IngredientEditVM(DataRow ingredientRow, TableModel<Entities.IngredientEntity> tableModel)//, uint dishId)
        ...
        {
            ParseFields();
            //Row.ItemArray = DataTableConverter.ToDataRow(Fields).ItemArray;

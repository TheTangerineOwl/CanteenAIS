    ...
    public class MeasureUnitFilterVM : BasicFilterVM<Entities.MeasureUnitEntity, Entities.MeasureUnit>
    {
        ...
        public string Name
        {
            ...
            set
            {
                if (_name == null)
                    _name = value;
                if (!ValueChecker.CheckValueString(value, out value, 16, true))
                    value = "";
                Set(ref _name, value);
            }
        }
        ...
        public override void ParseFields()
        {
            ...
            if (NameCheck)
            {
                if (!ValueChecker.CheckValueString(Name, out string name, 16, true))
        ...
        {
            ParseFields();
            Model.FetchAndFilter<Entities.MeasureUnit>((item) =>
